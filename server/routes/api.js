...
// Roles Routes
routerApi.get('/roles/noPagination', role_controller.role_list_without_pagination);
...
// Permissions Routes
routerApi.get('/permissions/noPagination', permission_controller.permission_list_without_pagination);
...
// Interpreters Routes
routerApi.get('/interpreters/noPagination', interpreter_controller.interpreter_list_without_pagination);
...
// Resources Routes
routerApi.get('/resources/noPagination', resource_controller.resource_list_without_pagination);
...
// Sowar Routes
routerApi.get('/surah/noPagination', surah_controller.surah_list_without_pagination);
...
// Titles Routes
routerApi.get('/titles/noPagination', title_controller.title_list_without_pagination);
...
// Timeline Routes
routerApi.get('/timelines/noPagination', timeline_controller.timeline_list_without_pagination);
...
routerApi.get('/documentationexplanation/noPagination', documentationExplanation_controller.documentationExplanation_list_without_pagination);
